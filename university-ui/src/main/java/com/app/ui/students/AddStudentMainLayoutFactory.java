...
import com.app.service.addstudent.AddStudentService;
import com.app.utils.Gender;
import com.app.utils.NotificationMessages;
	...
	private class AddStudentMainLayout extends VerticalLayout implements Button.ClickListener {
		...
		private void save() {
			...
			Notification.show(NotificationMessages.STUDENT_SAVE_SUCCESS_TITLE.getString(),
					NotificationMessages.STUDENT_SAVE_SUCCESS_DESCRIPTION.getString(), Type.HUMANIZED_MESSAGE);
		}
